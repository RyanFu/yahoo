...
public class SlideAnimationThenCallLayout extends Activity implements AnimationListener {
    ...
    class ClickListener implements OnClickListener {
        public void onClick(View v) {
            ...
            int left = (int) (menu.getMeasuredWidth()-150);
...
//        ViewUtils.initListView(this, listView, "Item ", 30, android.R.layout.simple_list_item_1);
        ...
        news_content = (TextView)app.findViewById(R.id.news_content);
        news_url = (TextView)app.findViewById(R.id.news_url);
        news_title = (TextView)app.findViewById(R.id.news_title);
